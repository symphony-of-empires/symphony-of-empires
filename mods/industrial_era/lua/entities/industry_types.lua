...
cotton_farm:add_input(Commodity:get("waste"))
...
sulphur_mine:add_input(Commodity:get("waste"))
...
winery:register()
winery:add_input(Commodity:get("waste"))
...
dye_industry:add_input(Commodity:get("waste"))
...
silk_plantation:add_input(Commodity:get("waste"))
...
spices_plantation:add_input(Commodity:get("waste"))
...
opium_plantation:add_input(Commodity:get("waste"))
