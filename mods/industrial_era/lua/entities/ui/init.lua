...
UI_RegisterCallback("ai_settings_window_invoke", function()
    ...
    ai_sett_win:set_text(_("AI Control"))
    ...
    cmd_chk:set_text(_("Command troops"))
...
function province_button(x, y, province_ref_name, parent_id)
    ...
    province_btn:set_text(province.name)
...
UI_RegisterCallback("map_dev_view_invoke", function()
    ...
    reload_shader_btn:set_text(_("Reload shaders"))
...
UI_RegisterCallback("settings_window_invoke", function()
    ...
    settings_win:set_text(_("Settings"))
    ...
    sdf_detail_chk:set_text(_("Multipass SDF"))
    ...
    lighting_chk:set_text(_("Light and Reflections"))
    ...
    local lighting_chk = UI_Checkbox:new(0, 0, 256, 24, graphics_flex.id)
    lighting_chk:set_text(_("City lights"))
    ...
    parallax_chk:set_text(_("3D Parallax"))
    ...
    rivers_chk:set_text(_("Advanced Rivers"))
    ...
    water_chk:set_text(_("Advanced Water"))
    ...
    grid_chk:set_text(_("Square grid"))
    ...
    buildings_chk:set_text(_("Buildings"))
    ...
    motion_blur_chk:set_text(_("Motion blur"))
    ...
    music_volume_sld:set_text(_("Music volume"))
    ...
    sound_volume_sld:set_text(_("Sound volume"))
