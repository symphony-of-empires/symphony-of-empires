...
province:add_pop(artisan, yankee, protestant, 300, 0.7)
province:add_pop(farmer, yankee, protestant, 2700, 0.6)
province:add_pop(soldier, yankee, protestant, 800, 0.8)
province:add_pop(craftsmen, yankee, protestant, 700, 0.5)
province:add_pop(bureaucrat, yankee, protestant, 200, 0.7)
province:add_pop(aristocrat, yankee, protestant, 200, 0.9)
province:add_pop(clergymen, yankee, protestant, 500, 0.9)
province:add_pop(laborer, yankee, protestant, 2700, 0.8)
province:add_pop(entrepreneur, yankee, protestant, 100, 0.9)
