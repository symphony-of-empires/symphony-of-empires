...
province:add_pop(artisan, Culture:get("american"), protestant, 300, 0.7)
province:add_pop(farmer, Culture:get("american"), protestant, 2700, 0.6)
province:add_pop(soldier, Culture:get("american"), protestant, 800, 0.8)
province:add_pop(craftsmen, Culture:get("american"), protestant, 700, 0.5)
province:add_pop(bureaucrat, Culture:get("american"), protestant, 200, 0.7)
province:add_pop(burgeoise, Culture:get("american"), protestant, 200, 0.9)
province:add_pop(clergymen, Culture:get("american"), protestant, 500, 0.9)
province:add_pop(laborer, Culture:get("american"), protestant, 2700, 0.8)
province:add_pop(burgeoise, Culture:get("american"), protestant, 100, 0.9)
