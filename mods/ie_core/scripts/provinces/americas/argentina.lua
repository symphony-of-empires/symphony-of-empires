...
province:register()
province:add_industry(sulfur_mine, russia, andes_transport)
province:add_industry(vineyard, russia, andes_transport)
province:add_industry(cotton_farm, russia, andes_transport)
province:add_industry(oil_refinery, russia, andes_transport)
province:add_industry(wheat_farm, russia, andes_transport)
province:add_pop(artisan, argentinian, catholic, 2000, 0.8)
province:add_pop(farmer, argentinian, catholic, 8000, 0.5)
province:add_pop(soldier, argentinian, catholic, 1000, 0.6)
...
province:register()
province:add_industry(oil_refinery, russia, andes_transport)
province:add_industry(rice_farm, russia, andes_transport)
province:add_industry(vineyard, russia, andes_transport)
province:add_industry(cotton_farm, russia, andes_transport)
province:add_pop(artisan, argentinian, catholic, 2000, 0.8)
province:add_pop(farmer, argentinian, catholic, 8000, 0.5)
...
province:add_industry(rice_farm, russia, andes_transport)
province:add_industry(vineyard, russia, andes_transport)
province:add_industry(lumberjack, russia, andes_transport)
province:add_pop(artisan, argentinian, catholic, 2000, 0.8)
province:add_pop(farmer, argentinian, catholic, 8000, 0.5)
province:add_pop(soldier, argentinian, catholic, 1000, 0.6)
province:add_pop(craftsmen, argentinian, catholic, 2000, 0.4)
