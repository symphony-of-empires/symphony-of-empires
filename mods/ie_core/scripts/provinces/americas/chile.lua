...
for k, v in pairs(chile_owned_provinces_list) do
    ...
    province:add_pop(craftsmen, Culture:get("chilean"), catholic, 2000, 0.4)
    province:add_pop(bureaucrat, Culture:get("chilean"), catholic, 500, 0.6)
