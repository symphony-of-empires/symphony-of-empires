...
tunis:add_client_hint(communism, _("Tunis"), 0x808000)
...
algeirs:add_client_hint(communism, _("Algeirs"), 0x808000)

abbyssina = Nation:new{ ref_name = "abbyssina" }
abbyssina.name = _("Abbyssina")
abbyssina:register()
abbyssina:add_client_hint(communism, _("Abbyssina"), 0x808000)

egypt = Nation:new{ ref_name = "egypt" }
egypt.name = _("Egypt")
egypt.adjective = _("Egyptians")
egypt:register()
egypt:add_client_hint(communism, _("Egypt"), 0x808000)
...
tripolitania:add_client_hint(communism, _("Tripolitania"), 0x808000)

ashantee = Nation:new{ ref_name = "ashantee" }
ashantee.name = _("Ashantee")
ashantee:register()
ashantee:add_client_hint(communism, _("Ashantee"), 0x808000)
-- Formable nations
...
arabia:add_client_hint(communism, _("Arabia"), 0x808000)
-----------------------------------------------------------------------
...
wadai_empire:add_client_hint(communism, _("Wadai Empire"), 0x808000)

bornu = Nation:new{ ref_name = "bornu" }
bornu.name = _("Bornu")
bornu:register()
bornu:add_client_hint(communism, _("Bornu"), 0x808000)

dahomey = Nation:new{ ref_name = "dahomey" }
dahomey.name = _("Dahomey")
dahomey:register()
dahomey:add_client_hint(communism, _("Dahomey"), 0x808000)
-----------------------------------------------------------------------