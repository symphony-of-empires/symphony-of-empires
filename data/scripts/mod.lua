...
AddOperationalProvinceToCompany(0, miyazaki.ref_name)
AddOperationalProvinceToCompany(0, yamaguchi.ref_name)
AddOperationalProvinceToCompany(0, tokushima.ref_name)
AddOperationalProvinceToCompany(0, hiroshima.ref_name)
AddOperationalProvinceToCompany(0, hokkaido.ref_name)
AddOperationalProvinceToCompany(0, south_hokkaido.ref_name)
AddOperationalProvinceToCompany(0, okayama.ref_name)
AddOperationalProvinceToCompany(0, hyogo.ref_name)
AddOperationalProvinceToCompany(0, osaka.ref_name)
AddOperationalProvinceToCompany(0, mie.ref_name)
AddOperationalProvinceToCompany(0, kyoto.ref_name)
AddOperationalProvinceToCompany(0, gifu.ref_name)
AddOperationalProvinceToCompany(0, shizuoka.ref_name)
AddOperationalProvinceToCompany(0, niigata.ref_name)
AddOperationalProvinceToCompany(0, yamanashi.ref_name)
AddOperationalProvinceToCompany(0, tokyo.ref_name)
AddOperationalProvinceToCompany(0, ibaraki.ref_name)
AddOperationalProvinceToCompany(0, fukushima.ref_name)
AddOperationalProvinceToCompany(0, tochigi.ref_name)
