...
: PackedModel(GL_TRIANGLES) {
    buffer.resize(6);
    buffer[0] = PackedData(glm::vec3(start_x, start_y, 0.0f), glm::vec2(0.f, 0.f), glm::vec3(1.f, 1.f, 1.f));
    buffer[1] = PackedData(glm::vec3(end_x, start_y, 0.0f), glm::vec2(1.f, 0.f), glm::vec3(1.f, 1.f, 1.f));
    buffer[2] = PackedData(glm::vec3(start_x, end_y, 0.0f), glm::vec2(0.f, 1.f), glm::vec3(1.f, 1.f, 1.f));
    buffer[3] = PackedData(glm::vec3(start_x, end_y, 0.0f), glm::vec2(0.f, 1.f), glm::vec3(1.f, 1.f, 1.f));
    buffer[4] = PackedData(glm::vec3(end_x, start_y, 0.0f), glm::vec2(1.f, 0.f), glm::vec3(1.f, 1.f, 1.f));
    buffer[5] = PackedData(glm::vec3(end_x, end_y, 0.0f), glm::vec2(1.f, 1.f), glm::vec3(1.f, 1.f, 1.f));
