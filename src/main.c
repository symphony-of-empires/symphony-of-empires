...
int main(int argc, char ** argv) {
	...
	Texture admin_icon;
	Texture_FromFile(&admin_icon, "data/admin_icon.png");
	Texture_ToOpenGL(&admin_icon);

	Texture supply_icon;
	Texture_FromFile(&supply_icon, "data/supply_icon.png");
	Texture_ToOpenGL(&supply_icon);

	Texture factory_icon;
	Texture_FromFile(&factory_icon, "data/factory_icon.png");
	...
	Texture help_icon;
	Texture_FromFile(&help_icon, "data/help_icon.png");
	...
	Texture budget_icon;
	Texture_FromFile(&budget_icon, "data/budget_icon.png");
	...
	Texture_FromFile(&pol_view_icon, "data/pol_view_icon.png");
	...
	Texture_FromFile(&prov_view_icon, "data/prov_view_icon.png");
	...
	Texture_FromFile(&topo_view_icon, "data/topo_view_icon.png");
	...
	Texture exit_icon;
	Texture_FromFile(&exit_icon, "data/exit_icon.png");
